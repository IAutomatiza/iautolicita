...
/* El nodo del panel: el favicon del sitio recreado en HTML (la
   loseta oscura con "iAL."), para que se lea "la alerta también
   queda en tu panel de IAutoLicita". */
const IconoPanel = () => (
  <span className="grid h-[22px] w-[22px] place-items-center rounded-[5px] bg-[#0A0A0A]">
    <span className="font-display text-[8.5px] font-bold leading-none tracking-[-0.02em] text-[#FAFAF9]">
      <span className="text-brand-400">iA</span>L<span className="text-brand-400">.</span>
    </span>
  </span>
);
...
const SALIDAS = [
  ...
  { label: "Telegram", y: 64, nodo: <IconoTelegram /> },
  { label: "Tu panel", y: 92, nodo: <IconoPanel /> },
];
