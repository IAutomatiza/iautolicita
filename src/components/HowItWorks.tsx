...
const steps = [
  ...
  },
  {
    ...
    body: "Cada licitación nueva la lee gpt-4o-mini, extrae bases técnicas, requisitos y riesgos. Score combina 3 capas: keywords + códigos UNSPSC + sectores objetivo con pesos Alta/Media/Baja.",
