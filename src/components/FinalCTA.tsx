...
export default function FinalCTA() {
  return (
    <section id="contacto" className="py-16 md:py-28 relative">
      <div className="mx-auto px-3 md:px-4 lg:px-5" style={{ maxWidth: 1920 }}>
        ...
        >
          ...
          <div className="relative max-w-[920px] mx-auto text-center">
            ...
            >
              Una demo de 20 minutos por WhatsApp. Te mostramos las licitaciones que matcheás <em className="not-italic" style={{ color: "#FFFFFF" }}>hoy mismo</em> y cómo verlas todos los días sin que tu equipo abra el portal.
            </p>
