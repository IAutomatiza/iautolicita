...
/* ── La escala de la base, que es la prueba del titular ───── */
  ...
  return (
    <section id="capacidades" className="py-16 md:py-28">
      <div className="container-edge">
        {/* Encabezado centrado (layout GitBook) con la banda de cifras del
            patrón Shopify Plus: el "mismo dato" deja de ser una promesa
            escrita y pasa a estar probado con la escala real de la base. */}
